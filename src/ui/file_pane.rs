...
use super::dialogs::ask::{confirm_likely, confirm_unlikely};
use super::dialogs::say::say_info;
use super::group_selector::select_group;
...
mod imp {
    ...
    impl ObjectImpl for FilePane {
        fn constructed(&self) {
            ...
            let popup = crate::ui::menu::create_tree_popup();
